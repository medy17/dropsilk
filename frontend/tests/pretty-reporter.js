...
export default class PrettyReporter {
    ...
    onInit(ctx) {
        try {
            ...
            // Suppress jsdom "Not implemented" warnings that pollute output
            this.originalStderr = process.stderr.write.bind(process.stderr);
            process.stderr.write = (chunk, ...args) => {
                const str = typeof chunk === 'string' ? chunk : chunk.toString();
                if (str.includes('Not implemented:') || str.includes('Error: Not implemented')) {

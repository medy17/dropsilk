...
export function getFileIcon(fileName) {
    ...
    if (['txt', 'js', 'jsx', 'ts', 'tsx', 'css', 'html', 'json', 'py', 'java', 'c', 'cpp', 'cs', 'go', 'rb', 'php', 'sh', 'yml', 'yaml', 'rtf'].includes(extension)) return `<svg viewBox="0 0 28 28" width="28" height="28" fill="none" stroke="currentColor"><rect x="4.2" y="5.55" width="19.6" height="16.8" rx="2.8" ry="2.8" fill="#f5eafd" stroke="var(--c-primary)" stroke-width="2.1"/><g stroke-linecap="round" stroke-linejoin="round"><polyline stroke="var(--c-secondary)" stroke-width="1.5" points="10.38 10.95 6.95 13.95 10.38 16.95"/><polyline stroke="var(--c-secondary)" stroke-width="1.5" points="17.62 10.95 21.05 13.95 17.62 16.95"/><line stroke="var(--c-primary)" stroke-width="1.8" x1="15.17" y1="9.44" x2="12.83" y2="18.46"/></g></svg>`;

...
export const store = {
    ...
    actions: {
        ...
        setRoomParticipantId: (participantId) => { state.roomParticipantId = participantId; },
        setRoomRole: (role) => { state.roomRole = role; },
        setRoomStatus: (status) => { state.roomStatus = status; },
        setRoomPeer: (peer) => { state.roomPeer = peer; },
        setSignalingInitiated: (value) => { state.signalingInitiated = value; },
